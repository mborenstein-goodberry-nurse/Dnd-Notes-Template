...
---
# The Story of The Privy Privateers
...
## [[Campaigns/The Privy Privateers/Quest Board/Quest Board|Quest Board]] 
![[Campaigns/The Privy Privateers/Quest Board/Quest Board#Active|Quest Board]]

## Journals
```dataview
TABLE summary as "Summary" from "Campaigns/The Privy Privateers/Session Journal"
...
### Other Characters 
```dataview
TABLE attitude as "Attitude", summary as "Summary" from "Campaigns/The Privy Privateers/World Almanac/People"
...
## Places 
```dataview
TABLE size as "Size", attitude as "Attitude", summary as "Summary" from "Campaigns/The Privy Privateers/World Almanac/Places"
