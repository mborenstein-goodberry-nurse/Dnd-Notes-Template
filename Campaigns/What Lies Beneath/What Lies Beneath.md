...
## [[Campaigns/What Lies Beneath/Quest Board/Quest Board|Quest Board]]
### Main Quest 
```dataviewjs 
...
from "Campaigns/What Lies Beneath/Quest Board"
...
```
## [[Campaigns/What Lies Beneath/Session Journal/Session Journal|Journals]] 
```dataview
TABLE date as "Date", sessionNum as "Session", summary as "Summary" 
from "Campaigns/What Lies Beneath/Session Journal"
...
from "Campaigns/What Lies Beneath/Da Party"
...
```dataview
TABLE attitude as "Attitude", summary as "Summary" 
from "Campaigns/What Lies Beneath/People"
...
## Places 
```dataview
TABLE from "Campaigns/What Lies Beneath/Maps"
where file.name != "Maps"
```
```dataview
TABLE size as "Size", attitude as "Attitude", summary as "Summary" 
from "Campaigns/What Lies Beneath/Places"
